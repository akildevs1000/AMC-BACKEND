...
<head>
    ...
    <meta data-n-head="ssr" data-hid="apple-mobile-web-app-title" name="apple-mobile-web-app-title" content="MyTime 2 Cloud">
    <meta data-n-head="ssr" data-hid="og:type" name="og:type" property="og:type" content="website">
    <meta data-n-head="ssr" data-hid="og:title" name="og:title" property="og:title" content="MyTime 2 Cloud">
    <meta data-n-head="ssr" data-hid="og:site_name" name="og:site_name" property="og:site_name" content="MyTime 2 Cloud">
    <title>MyTime 2 Cloud</title>
    ...
    <link data-n-head="ssr" data-hid="shortcut-icon" rel="shortcut icon" href="/_nuxt/icons/icon_64x64.60f3a2.png">
    <link data-n-head="ssr" data-hid="apple-touch-icon" rel="apple-touch-icon" href="/_nuxt/icons/icon_512x512.60f3a2.png" sizes="512x512">
    <link data-n-head="ssr" rel="manifest" href="/_nuxt/manifest.9e09ea6a.json" data-hid="manifest">
    <style data-n-head="vuetify" type="text/css" id="vuetify-theme-stylesheet" nonce="undefined">
        ...
        .v-application .primary--text.text--lighten-4 {
            ...
            caret-color: #e1afff !important;
        }

        .v-application .primary.lighten-3 {
            background-color: #c393ff !important;
            border-color: #c393ff !important;
        }

        .v-application .primary--text.text--lighten-3 {
            color: #c393ff !important;
            caret-color: #c393ff !important;
        }

        .v-application .primary.lighten-2 {
            background-color: #a579ff !important;
            border-color: #a579ff !important;
        }

        .v-application .primary--text.text--lighten-2 {
            color: #a579ff !important;
            caret-color: #a579ff !important;
        }

        .v-application .primary.lighten-1 {
            background-color: #875ffa !important;
            border-color: #875ffa !important;
        }

        .v-application .primary--text.text--lighten-1 {
            color: #875ffa !important;
            caret-color: #875ffa !important;
        }

        .v-application .primary.darken-1 {
            background-color: #492dc0 !important;
            border-color: #492dc0 !important;
        }

        .v-application .primary--text.text--darken-1 {
            color: #492dc0 !important;
            caret-color: #492dc0 !important;
        }

        .v-application .primary.darken-2 {
            background-color: #2314a5 !important;
            border-color: #2314a5 !important;
        }

        .v-application .primary--text.text--darken-2 {
            color: #2314a5 !important;
            caret-color: #2314a5 !important;
        }
        ...
        .v-application .accent {
            background-color: #d8363a !important;
            border-color: #d8363a !important;
        }

        .v-application .accent--text {
            color: #d8363a !important;
            caret-color: #d8363a !important;
        }

        .v-application .accent.lighten-5 {
            background-color: #ffc7b8 !important;
            border-color: #ffc7b8 !important;
        }

        .v-application .accent--text.text--lighten-5 {
            color: #ffc7b8 !important;
            caret-color: #ffc7b8 !important;
        }
        ...
        .v-application .accent--text.text--lighten-4 {
            color: #ffaa9d !important;
            caret-color: #ffaa9d !important;
        }

        .v-application .accent.lighten-3 {
            background-color: #ff8e83 !important;
            border-color: #ff8e83 !important;
        }

        .v-application .accent--text.text--lighten-3 {
            color: #ff8e83 !important;
            caret-color: #ff8e83 !important;
        }
        ...
        .v-application .accent--text.text--lighten-2 {
            ...
            caret-color: #ff716a !important;
        }

        .v-application .accent.lighten-1 {
            background-color: #f85451 !important;
            border-color: #f85451 !important;
        }

        .v-application .accent--text.text--lighten-1 {
            color: #f85451 !important;
            caret-color: #f85451 !important;
        }

        .v-application .accent.darken-1 {
            background-color: #b80c24 !important;
            border-color: #b80c24 !important;
        }

        .v-application .accent--text.text--darken-1 {
            color: #b80c24 !important;
            caret-color: #b80c24 !important;
        }

        .v-application .accent.darken-2 {
            background-color: #99000f !important;
            border-color: #99000f !important;
        }

        .v-application .accent--text.text--darken-2 {
            color: #99000f !important;
            caret-color: #99000f !important;
        }
        ...
        .v-application .background {
            ...
            border-color: #34444c !important;
        }

        .v-application .background--text {
            color: #34444c !important;
            caret-color: #34444c !important;
        }
        ...
        .v-application .background--text.text--lighten-5 {
            color: #b1c3cd !important;
            caret-color: #b1c3cd !important;
        }

        .v-application .background.lighten-4 {
            background-color: #96a8b1 !important;
            border-color: #96a8b1 !important;
        }

        .v-application .background--text.text--lighten-4 {
            color: #96a8b1 !important;
            caret-color: #96a8b1 !important;
        }

        .v-application .background.lighten-3 {
            background-color: #7c8e97 !important;
            border-color: #7c8e97 !important;
        }

        .v-application .background--text.text--lighten-3 {
            color: #7c8e97 !important;
            caret-color: #7c8e97 !important;
        }
        ...
        .v-application .background--text.text--lighten-2 {
            ...
            caret-color: #63747d !important;
        }

        .v-application .background.lighten-1 {
            background-color: #4b5b64 !important;
            border-color: #4b5b64 !important;
        }

        .v-application .background--text.text--lighten-1 {
            color: #4b5b64 !important;
            caret-color: #4b5b64 !important;
        }

        .v-application .background.darken-1 {
            background-color: #1e2e35 !important;
            border-color: #1e2e35 !important;
        }

        .v-application .background--text.text--darken-1 {
            color: #1e2e35 !important;
            caret-color: #1e2e35 !important;
        }

        .v-application .background.darken-2 {
            background-color: #081920 !important;
            border-color: #081920 !important;
        }

        .v-application .background--text.text--darken-2 {
            color: #081920 !important;
            caret-color: #081920 !important;
        }
        ...
        .v-application .main_bg {
            background-color: #ecf0f4 !important;
            border-color: #ecf0f4 !important;
        }

        .v-application .main_bg--text {
            color: #ecf0f4 !important;
            caret-color: #ecf0f4 !important;
        }

        .v-application .main_bg.lighten-5 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .main_bg--text.text--lighten-5 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .main_bg.lighten-4 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .main_bg--text.text--lighten-4 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .main_bg.lighten-3 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .main_bg--text.text--lighten-3 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .main_bg.lighten-2 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .main_bg--text.text--lighten-2 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .main_bg.lighten-1 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .main_bg--text.text--lighten-1 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .main_bg.darken-1 {
            background-color: #d0d4d8 !important;
            border-color: #d0d4d8 !important;
        }

        .v-application .main_bg--text.text--darken-1 {
            color: #d0d4d8 !important;
            caret-color: #d0d4d8 !important;
        }

        .v-application .main_bg.darken-2 {
            background-color: #b4b8bc !important;
            border-color: #b4b8bc !important;
        }

        .v-application .main_bg--text.text--darken-2 {
            color: #b4b8bc !important;
            caret-color: #b4b8bc !important;
        }

        .v-application .main_bg.darken-3 {
            background-color: #999da1 !important;
            border-color: #999da1 !important;
        }

        .v-application .main_bg--text.text--darken-3 {
            color: #999da1 !important;
            caret-color: #999da1 !important;
        }

        .v-application .main_bg.darken-4 {
            background-color: #7f8387 !important;
            border-color: #7f8387 !important;
        }

        .v-application .main_bg--text.text--darken-4 {
        ...
        .v-application .violet.lighten-5 {
            background-color: #ffcaff !important;
            border-color: #ffcaff !important;
        }

        .v-application .violet--text.text--lighten-5 {
            color: #ffcaff !important;
            caret-color: #ffcaff !important;
        }

        .v-application .violet.lighten-4 {
            background-color: #e1afff !important;
            border-color: #e1afff !important;
        }

        .v-application .violet--text.text--lighten-4 {
            color: #e1afff !important;
            caret-color: #e1afff !important;
        }

        .v-application .violet.lighten-3 {
            background-color: #c393ff !important;
            border-color: #c393ff !important;
        }

        .v-application .violet--text.text--lighten-3 {
            color: #c393ff !important;
            caret-color: #c393ff !important;
        }

        .v-application .violet.lighten-2 {
            background-color: #a579ff !important;
            border-color: #a579ff !important;
        }

        .v-application .violet--text.text--lighten-2 {
            color: #a579ff !important;
            caret-color: #a579ff !important;
        }
        ...
        .v-application .violet.darken-1 {
            background-color: #492dc0 !important;
            border-color: #492dc0 !important;
        }

        .v-application .violet--text.text--darken-1 {
            color: #492dc0 !important;
            caret-color: #492dc0 !important;
        }

        .v-application .violet.darken-2 {
            background-color: #2314a5 !important;
            border-color: #2314a5 !important;
        }

        .v-application .violet--text.text--darken-2 {
            color: #2314a5 !important;
            caret-color: #2314a5 !important;
        }

        .v-application .violet.darken-3 {
            background-color: #000089 !important;
            border-color: #000089 !important;
        }

        .v-application .violet--text.text--darken-3 {
            color: #000089 !important;
            caret-color: #000089 !important;
        }

        .v-application .violet.darken-4 {
            background-color: #00006f !important;
            border-color: #00006f !important;
        }

        .v-application .violet--text.text--darken-4 {
            color: #00006f !important;
            caret-color: #00006f !important;
        }
        ...
        .v-application .popup_background--text {
            color: #ecf0f4 !important;
            caret-color: #ecf0f4 !important;
        }

        .v-application .popup_background.lighten-5 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .popup_background--text.text--lighten-5 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .popup_background.lighten-4 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .popup_background--text.text--lighten-4 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .popup_background.lighten-3 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .popup_background--text.text--lighten-3 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .popup_background.lighten-2 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .popup_background--text.text--lighten-2 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .popup_background.lighten-1 {
            background-color: #ffffff !important;
            border-color: #ffffff !important;
        }

        .v-application .popup_background--text.text--lighten-1 {
            color: #ffffff !important;
            caret-color: #ffffff !important;
        }

        .v-application .popup_background.darken-1 {
            background-color: #d0d4d8 !important;
            border-color: #d0d4d8 !important;
        }

        .v-application .popup_background--text.text--darken-1 {
            color: #d0d4d8 !important;
            caret-color: #d0d4d8 !important;
        }

        .v-application .popup_background.darken-2 {
            background-color: #b4b8bc !important;
            border-color: #b4b8bc !important;
        }

        .v-application .popup_background--text.text--darken-2 {
            color: #b4b8bc !important;
            caret-color: #b4b8bc !important;
        }

        .v-application .popup_background.darken-3 {
            background-color: #999da1 !important;
            border-color: #999da1 !important;
        }

        .v-application .popup_background--text.text--darken-3 {
            color: #999da1 !important;
            caret-color: #999da1 !important;
        }

        .v-application .popup_background.darken-4 {
            background-color: #7f8387 !important;
            border-color: #7f8387 !important;
        }

        .v-application .popup_background--text.text--darken-4 {
            color: #7f8387 !important;
            caret-color: #7f8387 !important;
        }
    </style>
    ...
    <link rel="preload" href="/_nuxt/app.bd7f00a7aeaa4e0e4a16.hot-update.js" as="script">
    <link rel="preload" href="/_nuxt/pages/amc/print/_id.js" as="script">
    <style data-vue-ssr-id="5b07c19f:0">
 ...
 * */
        ...
        .v-timeline:not(.v-timeline--dense):not(.v-timeline--reverse) .v-timeline-item:nth-child(even):not(.v-timeline-item--after),
        .v-timeline:not(.v-timeline--dense):not(.v-timeline--reverse) .v-timeline-item--before {
            flex-direction: row;
        }

        .v-application--is-ltr .v-timeline:not(.v-timeline--dense):not(.v-timeline--reverse) .v-timeline-item:nth-child(even):not(.v-timeline-item--after) .v-timeline-item__opposite,
        ...
        .v-application--is-rtl .v-timeline:not(.v-timeline--dense):not(.v-timeline--reverse) .v-timeline-item:nth-child(even):not(.v-timeline-item--after) .v-timeline-item__opposite,
        ...
        .v-application--is-ltr .v-timeline:not(.v-timeline--dense):not(.v-timeline--reverse) .v-timeline-item:nth-child(even):not(.v-timeline-item--after) .v-timeline-item__body>.v-card::after,
        ...
        .v-application--is-rtl .v-timeline:not(.v-timeline--dense):not(.v-timeline--reverse) .v-timeline-item:nth-child(even):not(.v-timeline-item--after) .v-timeline-item__body>.v-card::after,
        ...
        .v-timeline:not(.v-timeline--dense):not(.v-timeline--reverse) .v-timeline-item:nth-child(even):not(.v-timeline-item--after) .v-timeline-item__body,
        ...
        .v-application--is-ltr .v-timeline--reverse:not(.v-timeline--dense) .v-timeline-item:nth-child(even):not(.v-timeline-item--before) .v-timeline-item__opposite,
        .v-application--is-ltr .v-timeline--reverse:not(.v-timeline--dense) .v-timeline-item--after .v-timeline-item__opposite {
            text-align: right;
        }

        .v-application--is-rtl .v-timeline--reverse:not(.v-timeline--dense) .v-timeline-item:nth-child(even):not(.v-timeline-item--before) .v-timeline-item__opposite,
        ...
        .v-application--is-rtl .v-timeline--reverse:not(.v-timeline--dense) .v-timeline-item:nth-child(even):not(.v-timeline-item--before) .v-timeline-item__body>.v-card::after,
        ...
        .v-timeline--reverse:not(.v-timeline--dense) .v-timeline-item:nth-child(even):not(.v-timeline-item--before) .v-timeline-item__body,
    ...
    <style data-vue-ssr-id="2e70115d:0">
        .mx-icon-left:before,
    ...
    <style data-vue-ssr-id="168e0ed8:0">
        .nuxt-progress {
            position: fixed;
            top: 0px;
            left: 0px;
    ...
    <style data-vue-ssr-id="59c923bf:0">
    ...
    <style data-vue-ssr-id="16c2abcb:0">
        *[data-v-27254557] {
        ...
        *[data-v-27254557] {
        ...
        .my-blue[data-v-27254557] {
            background-color: #4640d4 !important;
        }

        .my-green[data-v-27254557] {
            background-color: #a2b63b !important;
        }

        .my-red[data-v-27254557] {
            background-color: #e04e4f !important;
        }

        .uppercase-text[data-v-27254557] {
            text-transform: uppercase;
        }

        .top-border[data-v-27254557] {
            border-top: 1px solid #dddddd;
        }

        .bottom-border[data-v-27254557] {
            border-bottom: 1px solid #dddddd;
        }

        .border[data-v-27254557] {
            border: 1px solid #dddddd;
        }

        .tb-border[data-v-27254557] {
            border-top: 1px solid #dddddd;
            border-bottom: 1px solid #dddddd;
        }

        table[data-v-27254557] {
            border-collapse: collapse;
            width: 100%;
        }
        ...
        .left-border[data-v-27254557] {
            border-left: 1px solid #dddddd;
        }

        .right-border[data-v-27254557] {
            border-right: 1px solid #dddddd;
        }

        @media print {
            .no-print[data-v-27254557] {
                display: none;
            }
            ...
            .footer-print[data-v-27254557] {
                position: fixed;
                bottom: 0;
                width: 100%;
            }

            .page-break[data-v-27254557] {
            ...
            .table-font-color[data-v-27254557] {
                color: #777777;
            }
            ...
            .footer-font-size[data-v-27254557] {
                font-size: 9px;
            }
        }
    </style>
...
<body>
            ...
            return {
                ...
                state: {
                    ...
                    dashboard: {
                        ...
                        date_to: a,
                        recent_logs: a,
                        previous_week_attendance_count: a,
                        attendance_count: a,
                        off_devices_count: a,
                        leaves_request_count: a,
                        announcements: a,
                        every_hour_count: a,
                        web_logins: a,
                        attendance_count_by_department: a,
                        branch_id: a,
                        system_user_id: a,
                        visitor_every_hour_count: a
                    },
                    auth: {
                        user: a,
                        loggedIn: false,
    ...
    <script src="/_nuxt/pages/amc/print/_id.js" defer></script>
    ...
    <script src="/_nuxt/app.bd7f00a7aeaa4e0e4a16.hot-update.js" defer></script>
</body>
