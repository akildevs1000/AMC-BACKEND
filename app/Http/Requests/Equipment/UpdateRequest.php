...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if ($this->equipment_category_id == 1) {
            $arr = [
                "recorder_brand" => "required|min:1|max:50",
                "recorder_qty" => "required|min:1|max:50",
                "recorder_capacity" => "nullable|min:1|max:50",

                "work_station" => "required|min:1|max:50",
                "work_station_qty" => "required|min:1|max:50",

                "camera" => "required|min:1|max:50",
                "camera_qty" => "required|min:1|max:50",

                "monitor" => "required|min:1|max:50",
                "monitor_qty" => "required|min:1|max:50",

                "ups" => "required|min:1|max:50",
                "ups_qty" => "required|min:1|max:50",
                "ups_specs" => "nullable|min:1|max:50",

                "network" => "required|min:1|max:50",
                "network_qty" => "required|min:1|max:50",
                "network_specs" => "nullable|min:1|max:50",
            ];
            ...
            $arr = [
                ...
                "reader" => "required|min:1|max:50",
                "reader_qty" => "required|min:1|max:50",
                "reader_type" => "nullable|min:1|max:50",

                "lock" => "required|min:1|max:50",
                "lock_qty" => "required|min:1|max:50",
                "lock_type" => "nullable|min:1|max:50",
                ...
                "exit_switch" => "required|min:1|max:50",
                "fire_switch" => "required|min:1|max:50",
                "remote" => "nullable|min:1|max:50",
            ...
            $arr = [
                ...
                "sensor" => "required|min:1|max:50",
                "sensor_qty" => "required|min:1|max:50",
                "sensor_type" => "required|min:1|max:50",

                "keypad" => "required|min:1|max:50",
                "keypad_qty" => "required|min:1|max:50",
                "keypad_type" => "nullable|min:1|max:50",

                "ups" => "nullable|min:1|max:50",
                "ups_qty" => "nullable|min:1|max:50",
                "ups_type" => "nullable|min:1|max:50",
                "ups_specs" => "nullable|min:1|max:50",
                ...
                "auto_light" => "nullable|min:1|max:50",
                "auto_light_qty" => "nullable|min:1|max:50",
            ];
        }
